...
$adtSession = @{
    ...
    AppProcessesToCloseStart = @('###APPSTOCLOSESTART###')
    AppProcessesToCloseEnd = @('###APPSTOCLOSESTARTEND###')
    AppScriptVersion = '1.0.0'
    AppScriptDate = '###APPDATE###'
    AppScriptAuthor = 'Application Factory'
...
function Install-ADTDeployment
{
    ...
    if ($adtSession.AppProcessesToCloseStart.Count -gt 0)
    {
        $saiwParams.Add('CloseProcesses', $adtSession.AppProcessesToCloseStart)
    }
...
function Uninstall-ADTDeployment
{
    ...
    if ($adtSession.AppProcessesToCloseEnd.Count -gt 0)
    {
        Show-ADTInstallationWelcome -CloseProcesses $adtSession.AppProcessesToCloseEnd -CloseProcessesCountdown 60
    }
